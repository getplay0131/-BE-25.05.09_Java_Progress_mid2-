...
public class javaListPerfornanceTest {
    ...
    private static void getIndex(List<Integer> list, int loop, int idx){
        long startTime = System.currentTimeMillis();
        for (int i = 0; i < loop ; i++) {
            list.get(idx);
        }
        long endTime = System.currentTimeMillis();
        System.out.println("index : " + idx + ", 반복 : " + loop + ", 계산 시간 : " + (endTime - startTime) + "ms");
    }
