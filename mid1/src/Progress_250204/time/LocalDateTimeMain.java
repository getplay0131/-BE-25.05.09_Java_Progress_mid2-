...
//        비교
        System.out.println("현재 날짜가 지정 시간 이전인가? " + nowDt.isBefore(ofDt));
        System.out.println("현재 날짜가 지정 시간 이후인가? " + nowDt.isAfter(ofDt));
        System.out.println("현재 날짜가 지정 시간과 같은가? " + nowDt.isEqual(ofDt));
